...
/**
 * Session-only force for the ARMED plan's window (the per-plan sibling of
 * the night pill's override). Pass true to make the armed plan's schedule
 * cap apply regardless of the clock, false to suppress it regardless of
 * the clock, or null to follow the window again. Re-arming/clearing the
 * plan and every boot reset it. Returns appliedPlanInfo.
 */
